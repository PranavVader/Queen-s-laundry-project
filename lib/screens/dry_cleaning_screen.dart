          ...
          Expanded(
            child: Card(
              ...
              child: Container(
                ...
                child: ListView(
                  children: [
                    _buildPriceItem("T-SHIRT", "Rs. 32"),
                    _buildPriceItem("SHIRT", "Rs. 40"),
                    _buildPriceItem("PANT", "Rs. 50"),
                    _buildPriceItem("JACKET", "Rs. 55"),
                    _buildPriceItem("SWEATSHIRT", "Rs. 45"),
                    _buildPriceItem("LIGHT TEXTILES", "Rs. 35"),
                    _buildPriceItem("SHORTS", "Rs. 45"),
                    _buildPriceItem("BLANKETS", "Rs. 60"),
                    _buildPriceItem("PILLOW CASE", "Rs. 18"),
                  ],
                ),
              ),
            ),
