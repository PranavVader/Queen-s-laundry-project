...
class WashingDryingScreen extends StatelessWidget {
  @override
          ...
          Expanded(
            child: Card(
              ...
              child: Container(
                ...
                child: ListView(
                  children: [
                    _buildPriceItem("T-SHIRT", "Rs. 12"),
                    _buildPriceItem("SHIRT", "Rs. 20"),
                    _buildPriceItem("PANT", "Rs. 30"),
                    _buildPriceItem("JACKET", "Rs. 35"),
                    _buildPriceItem("SWEATSHIRT", "Rs. 25"),
                    _buildPriceItem("LIGHT TEXTILES", "Rs. 15"),
                    _buildPriceItem("SHORTS", "Rs. 25"),
                    _buildPriceItem("BLANKETS", "Rs. 40"),
                    _buildPriceItem("PILLOW CASE", "Rs. 8"),
                  ],
                ),
              ),
            ),
