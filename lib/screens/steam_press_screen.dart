...
class SteamPressScreen extends StatelessWidget {
  @override
          ...
          Expanded(
            child: Card(
              ...
              child: Container(
                ...
                child: ListView(
                  children: [
                    _buildPriceItem("T-SHIRT", "Rs. 10"),
                    _buildPriceItem("SHIRT", "Rs. 15"),
                    _buildPriceItem("PANT", "Rs. 20"),
                    _buildPriceItem("JACKET", "Rs. 25"),
                    _buildPriceItem("SWEATSHIRT", "Rs. 20"),
                    _buildPriceItem("LIGHT TEXTILES", "Rs. 12"),
                    _buildPriceItem("SHORTS", "Rs. 10"),
